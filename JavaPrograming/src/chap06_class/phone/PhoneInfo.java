...
public class PhoneInfo {
	...
	public PhoneInfo() {
		...
		try {
			Reader reader = new FileReader("C:/Dev224/JAVA/name.txt");
			...
			reader = new FileReader("C:/Dev224/JAVA/phone.txt");
	...
	public void saveData() {
		try {
			Writer writer = new FileWriter("C:/Dev224/JAVA/name.txt");
			...
			writer = new FileWriter("C:/Dev224/JAVA/phone.txt");
